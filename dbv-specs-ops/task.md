...
> **Estado:** Fases 0 a 19 completadas · v0.4.0 en curso de publicación (repo + Release + landing page en GitHub Pages) · instancia única multi-ventana (RF-14), enlace a mermaid.live (RF-15), comprobación de actualizaciones (RF-13) e instalador NSIS con pantalla de componentes
