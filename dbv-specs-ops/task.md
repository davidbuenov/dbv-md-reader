...
> **Estado:** Fases 0 a 20 completadas · v0.5.0 lista para publicar (rebrand a "DBV Markdown Reader", instalador NSIS con tema visual moderno, paquete MSIX con identidad real de Partner Center, política de privacidad) · instancia única multi-ventana (RF-14), enlace a mermaid.live (RF-15), comprobación de actualizaciones (RF-13)
